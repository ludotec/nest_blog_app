...
// import 'cypress.file-upload': // WARNING con interfaz pudes usar este plugin haciendo:
...
context('Teniendo algunos registros creados, vamos a subir una imagenpara uno de ellos y ver que accediendo a la página del perfil de ese usuario, tenemos todos sus datos de perfil', () => {
    // Esto es suceptible de convertirse en un comando ya que es muy usado
    beforeEach('1. Limpiar la base de datos, 2. crear 25 usuarios aleatorios, 3. create one knowed user, 4. login with this user', () => {
        // ## 1
 ...
 // WARNING no implementado correctamente, no sube la imagen
